...
Content Masternode not in the drop-down box?!

Copy / paste the contract address below into the "Contract Address" field. 
Make sure that the *no contract* is selected in the "Select Existing Contract" dropdown.


```

0x6c042141C302C354509d2bff30EEFDEF24dE1047
```

the **JSON Interface field** needs to be populated with:
